...
class EstimateEditMoreScreenAc extends StatefulWidget {
  final String? status;

  const EstimateEditMoreScreenAc({super.key, this.status});

  @override
  State<EstimateEditMoreScreenAc> createState() =>
      _EstimateEditMoreScreenAcState();
}

class _EstimateEditMoreScreenAcState extends State<EstimateEditMoreScreenAc> {
  late Size size;
