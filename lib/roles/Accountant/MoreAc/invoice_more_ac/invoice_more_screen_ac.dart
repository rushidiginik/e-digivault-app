...
class InvoiceMoreScreenAc extends StatefulWidget {
  final Widget icon;
  final String title;

  const InvoiceMoreScreenAc({
    super.key,
    required this.icon,
    required this.title,
  });
  ...
  @override
  State<InvoiceMoreScreenAc> createState() => _InvoiceMoreScreenAcState();
}

class _InvoiceMoreScreenAcState extends State<InvoiceMoreScreenAc> {
  late Size size;
