...
class InvoiceMoreViewAc extends StatefulWidget {
  final String? status;

  const InvoiceMoreViewAc({super.key, this.status});

  @override
  State<InvoiceMoreViewAc> createState() => _InvoiceMoreViewAcState();
}

class _InvoiceMoreViewAcState extends State<InvoiceMoreViewAc> {
  late Size size;
