...
class ProposalMoreScreenAc extends StatefulWidget {
  final Widget icon;
  final String title;

  const ProposalMoreScreenAc({
    super.key,
    required this.icon,
    required this.title,
  });
  ...
  @override
  State<ProposalMoreScreenAc> createState() => _ProposalMoreScreenAcState();
}

class _ProposalMoreScreenAcState extends State<ProposalMoreScreenAc> {
  late Size size;
    ...
    return Column(
      children: [
        ...
        ElevatedButton(
          ...
          onPressed: () {
            context.pushNamed('acProposalMoreView');
          },
          child: Text(
            "Create Proposal",
