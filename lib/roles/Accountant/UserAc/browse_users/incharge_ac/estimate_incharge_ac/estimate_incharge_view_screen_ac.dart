...
class EstimateInchargeViewScreenAc extends StatefulWidget {
  final String status;

  const EstimateInchargeViewScreenAc({super.key, required this.status});

  @override
  State<EstimateInchargeViewScreenAc> createState() =>
      _EstimateInchargeViewScreenAcState();
}

class _EstimateInchargeViewScreenAcState
    extends State<EstimateInchargeViewScreenAc> {
