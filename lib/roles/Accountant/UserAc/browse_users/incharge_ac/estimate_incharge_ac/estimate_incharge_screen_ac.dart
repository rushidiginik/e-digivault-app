...
class EstimateInchargeScreenAc extends StatefulWidget {
  const EstimateInchargeScreenAc({super.key});

  @override
  State<EstimateInchargeScreenAc> createState() =>
      _EstimateInchargeScreenAcState();
}

class _EstimateInchargeScreenAcState extends State<EstimateInchargeScreenAc> {
  late Size size;
