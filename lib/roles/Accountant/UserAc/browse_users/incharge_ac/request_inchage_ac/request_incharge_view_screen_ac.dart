...
class RequestInchargeViewScreenAc extends StatefulWidget {
  final String status;

  const RequestInchargeViewScreenAc({super.key, required this.status});

  @override
  State<RequestInchargeViewScreenAc> createState() =>
      _RequestInchargeViewScreenAcState();
}

class _RequestInchargeViewScreenAcState
    extends State<RequestInchargeViewScreenAc> {
