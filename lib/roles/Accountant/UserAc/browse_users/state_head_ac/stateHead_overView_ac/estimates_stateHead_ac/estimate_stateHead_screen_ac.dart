...
class EstimateStateheadScreenAc extends StatefulWidget {
  const EstimateStateheadScreenAc({super.key});

  @override
  State<EstimateStateheadScreenAc> createState() =>
      _EstimateStateheadScreenAcState();
}

class _EstimateStateheadScreenAcState extends State<EstimateStateheadScreenAc> {
  late Size size;
