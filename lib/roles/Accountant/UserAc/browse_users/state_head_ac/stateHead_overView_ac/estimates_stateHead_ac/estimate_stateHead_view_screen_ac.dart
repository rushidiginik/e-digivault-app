...
class EstimateStateheadViewScreenAc extends StatefulWidget {
  final String? status;

  const EstimateStateheadViewScreenAc({super.key, this.status});

  @override
  State<EstimateStateheadViewScreenAc> createState() =>
      _EstimateStateheadViewScreenAcState();
}

class _EstimateStateheadViewScreenAcState
    extends State<EstimateStateheadViewScreenAc> {
  late Size size;
