...
class ProposalsStateheadScreenAc extends StatefulWidget {
  const ProposalsStateheadScreenAc({super.key});

  @override
  State<ProposalsStateheadScreenAc> createState() =>
      _ProposalsStateheadScreenAcState();
}

class _ProposalsStateheadScreenAcState
    extends State<ProposalsStateheadScreenAc> {
  late Size size;
