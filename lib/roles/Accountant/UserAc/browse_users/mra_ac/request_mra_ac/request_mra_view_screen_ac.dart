...
class RequestMraViewScreenAc extends StatefulWidget {
  final String status;

  const RequestMraViewScreenAc({super.key, required this.status});

  @override
  State<RequestMraViewScreenAc> createState() => _RequestMraViewScreenAcState();
}

class _RequestMraViewScreenAcState extends State<RequestMraViewScreenAc> {
