...
class EstimateMraScreenAc extends StatefulWidget {
  const EstimateMraScreenAc({super.key});

  @override
  State<EstimateMraScreenAc> createState() => _EstimateMraScreenAcState();
}

class _EstimateMraScreenAcState extends State<EstimateMraScreenAc> {
  late Size size;
