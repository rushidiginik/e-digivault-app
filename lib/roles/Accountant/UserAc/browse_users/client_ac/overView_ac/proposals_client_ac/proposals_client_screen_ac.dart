...
class ProposalsClientScreenAc extends StatefulWidget {
  const ProposalsClientScreenAc({super.key});

  @override
  State<ProposalsClientScreenAc> createState() =>
      _ProposalsClientScreenAcState();
}

class _ProposalsClientScreenAcState extends State<ProposalsClientScreenAc> {
  late Size size;
