...
class InvoiceViewScreenAc extends StatefulWidget {
  final String? status;

  const InvoiceViewScreenAc({super.key, this.status});

  @override
  State<InvoiceViewScreenAc> createState() => _InvoiceViewScreenAcState();
}

class _InvoiceViewScreenAcState extends State<InvoiceViewScreenAc> {
  late Size size;
