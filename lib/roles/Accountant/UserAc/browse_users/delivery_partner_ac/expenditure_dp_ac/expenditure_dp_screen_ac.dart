...
class ExpenditureDpScreenAc extends StatefulWidget {
  const ExpenditureDpScreenAc({super.key});

  @override
  State<ExpenditureDpScreenAc> createState() => _ExpenditureDpScreenAcState();
}

class _ExpenditureDpScreenAcState extends State<ExpenditureDpScreenAc> {
  late Size size;
                ...
                DataCell(
                  SizedBox(
                    ...
                    child: row["receipt"] == "View"
                        ? GestureDetector(
                            onTap: () {
                              context.pushNamed('acExpenditureDpView');
                            },
                            child: Padding(
