...
class InoviceBusinessViewScreenAc extends StatefulWidget {
  final String? status;

  const InoviceBusinessViewScreenAc({super.key, this.status});

  @override
  State<InoviceBusinessViewScreenAc> createState() =>
      _InoviceBusinessViewScreenAcState();
}

class _InoviceBusinessViewScreenAcState
    extends State<InoviceBusinessViewScreenAc> {
  late Size size;
