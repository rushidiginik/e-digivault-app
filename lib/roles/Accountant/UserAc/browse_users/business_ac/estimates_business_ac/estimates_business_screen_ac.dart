...
class EstimatesBusinessScreenAc extends StatefulWidget {
  const EstimatesBusinessScreenAc({super.key});

  @override
  State<EstimatesBusinessScreenAc> createState() =>
      _EstimatesBusinessScreenAcState();
}

class _EstimatesBusinessScreenAcState extends State<EstimatesBusinessScreenAc> {
  late Size size;
