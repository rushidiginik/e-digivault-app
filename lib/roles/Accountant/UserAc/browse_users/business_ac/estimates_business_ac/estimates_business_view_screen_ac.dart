...
class EstimatesBusinessViewScreenAc extends StatefulWidget {
  final String? status;

  const EstimatesBusinessViewScreenAc({super.key, this.status});

  @override
  State<EstimatesBusinessViewScreenAc> createState() =>
      _EstimatesBusinessViewScreenAcState();
}

class _EstimatesBusinessViewScreenAcState
    extends State<EstimatesBusinessViewScreenAc> {
  late Size size;
