...
class BusinessOverviewScreenAc extends StatefulWidget {
  const BusinessOverviewScreenAc({super.key});

  @override
  State<BusinessOverviewScreenAc> createState() =>
      _BusinessOverviewScreenAcState();
}

class _BusinessOverviewScreenAcState extends State<BusinessOverviewScreenAc> {
  late Size size;
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        appBar: CommonHeader(title: 'BD', showBack: true),
