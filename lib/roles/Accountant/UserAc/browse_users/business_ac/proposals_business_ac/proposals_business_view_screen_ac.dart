...
class ProposalsBusinessViewScreenAc extends StatefulWidget {
  final String? status;

  const ProposalsBusinessViewScreenAc({super.key, this.status});

  @override
  State<ProposalsBusinessViewScreenAc> createState() =>
      _ProposalsBusinessViewScreenAcState();
}

class _ProposalsBusinessViewScreenAcState
    extends State<ProposalsBusinessViewScreenAc> {
  late Size size;
