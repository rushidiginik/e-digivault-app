...
class HomeScreenAc extends StatefulWidget {
  const HomeScreenAc({super.key});

  @override
  State<HomeScreenAc> createState() => _HomeScreenAcState();
}

class _HomeScreenAcState extends State<HomeScreenAc> {
  int selectedTab = 0;
  int segmentIndex = 1;
          ...
          children: [
            ...
            CustomCardWidget(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const CardHeader(title: "Invoice Overview"),
                  const SizedBox(height: 12),
                  CustomInvoiceOverview(),
                ],
              ),
            ),
          ],
