...
class RequestPaymentViewScreenMra extends StatefulWidget {
  final String status;

  const RequestPaymentViewScreenMra({super.key, required this.status});

  @override
  State<RequestPaymentViewScreenMra> createState() =>
      _RequestPaymentViewScreenMraState();
}

class _RequestPaymentViewScreenMraState
    extends State<RequestPaymentViewScreenMra> {
