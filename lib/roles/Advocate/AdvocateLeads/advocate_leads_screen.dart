...
class AdvocateLeadsScreen extends StatefulWidget {
  const AdvocateLeadsScreen({super.key});

  @override
  State<AdvocateLeadsScreen> createState() => _AdvocateLeadsScreenState();
}

class _AdvocateLeadsScreenState extends State<AdvocateLeadsScreen> {
  late Size size;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CommonHeader(title: 'Report', showBack: false),
  ...
  Widget _iconSection() {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          // Add New Leads Button (Blue)
          SizedBox(
            height: 44,
            width: size.width * 0.42,
            child: ButtonWidgetIconEnd(
              onTap: () {
                // Navigate to Add New Lead
                router.push('/lead_addnew_screen');
              },
              titleSize: 14,
              title: "Add new Leads",
              icons: Icons.add,
          ...
          // Leads Report Button (White)
          SizedBox(
            height: 44,
            width: size.width * 0.42,
            child: ButtonWidgetIconEnd(
              onTap: () {
                // Navigate to Leads Report
                router.push('/lead_report_screen');
              },
              titleSize: 14,
              title: "Leads Report",
