...
class _HomePageBDScreenState extends State<HomePageBDScreen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(children: [_salesInsightsSection(), _taskCardSection(), _iconSection(), _recentActivitySection()]),
        ),
      ),
    );
  }
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    textRegular(text: "Task", fontSize: 16, fontWeight: FontWeight.w600),
                    // Column(
                    //   crossAxisAlignment: CrossAxisAlignment.center,
                    //   mainAxisAlignment: MainAxisAlignment.center,
                    //   children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _taskItem(color: AppStyles.green2E, label: "Estimated", value: "200"),
                    SizedBox(height: 1.h),
                    _taskItem(color: AppStyles.orangeF5, label: "Proposal", value: "100"),
                    SizedBox(height: 1.h),
                    _taskItem(color: AppStyles.redFD, label: "Invoice", value: "120"),
                  ],
                ),
                ...
                Row(
                  children: [
                    Expanded(
                      flex: 100,
                      child: _progressSegment(backgroundColor: AppStyles.lightGreen9f, fillPercent: 0.77, fillColor: AppStyles.green00),
                    ),
                    SizedBox(width: 2.w),
                    Expanded(
                      flex: 100,
                      child: _progressSegment(backgroundColor: AppStyles.blueFF, fillPercent: 0.77, fillColor: AppStyles.blueCE),
                    ),
                    SizedBox(width: 2.w),
                    Expanded(
                      flex: 100,
                      child: _progressSegment(backgroundColor: AppStyles.redC8, fillPercent: 0.77, fillColor: AppStyles.red4C),
                    ),
                  ],
                ),
              ],
  ...
  Widget _taskItem({required Color color, required String label, required String value}) {
    return Row(
      children: [
        Container(
          width: 8,
        ...
        Expanded(
          child: textRegular(text: "$label - $value", fontSize: 14, fontColor: Colors.black87),
        ),
      ],
    );
  }

  Widget _progressSegment({required double fillPercent, required Color fillColor, required Color backgroundColor}) {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: _insightItem(percent: 0.75, value: "12", label: "GAP", progressColor: AppStyles.orangeF5, backgroundColor: AppStyles.lightOrangeF5),
                ),
                Expanded(
                  child: _insightItem(percent: 0.55, value: "12", label: "GAP", progressColor: AppStyles.blue2F, backgroundColor: AppStyles.lightBlueDD),
                ),
                Expanded(
                  child: _insightItem(
                    percent: 0.25,
                ...
                Expanded(
                  child: _insightItem(percent: 0.25, value: "62", label: "GAP Pending", progressColor: AppStyles.redFD, backgroundColor: AppStyles.redA4),
                ),
              ],
            ),
          ],
    ...
    return Column(
      children: [
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            _dashIconConst(onTap: () {}, title: "brochure",),
            _dashIconConst(onTap: () {}, title: "rate chart",),
            _dashIconConst(onTap: () {}, title: "service documents",),
            _dashIconConst(onTap: () {}, title: "video promo", ),
          ],
        ),
        Padding(
        ...
        ButtonWidget(onTap: () {}, title: "Live Tracking", width: size.width * 0.55),
      ],
    );
  }
  ...
  Widget _insightItem({required double percent, required String value, required String label, required Color progressColor, required Color backgroundColor}) {
    return Column(
      children: [
        ...
        SizedBox(
          height: 34,
          child: textRegular(text: label, fontSize: 12, textAlign: TextAlign.center, fontColor: progressColor),
        ),
      ],
    );
  }

  Widget _dashIconConst({required Function() onTap, required String title,}) {
