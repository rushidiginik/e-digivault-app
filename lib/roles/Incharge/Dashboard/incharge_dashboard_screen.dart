...
import 'package:e_digivault_org_app/roles/Incharge/HomePageIncharge/home_page_incharge.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_svg/flutter_svg.dart';

class InchargeDashboardScreen extends StatefulWidget {
  const InchargeDashboardScreen({super.key});
...
class _InchargeDashboardScreenState extends State<InchargeDashboardScreen> {
  ...
  void initState() {
    ...
    _screens = const [
      HomePageIncharge(),
      // InchargeUserScreen(),
      // InchargeEstimateScreen(),
      // InchargePaymentScreen(),
      // SettingScreen(),
    ];
  }
