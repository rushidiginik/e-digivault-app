...
class TextContainerConst extends StatefulWidget {
  final String labelTitle, value;
  final double? width;

  const TextContainerConst({
    super.key,
  ...
  @override
  State<TextContainerConst> createState() => _TextContainerConstState();
}

class _TextContainerConstState extends State<TextContainerConst> {
  @override
